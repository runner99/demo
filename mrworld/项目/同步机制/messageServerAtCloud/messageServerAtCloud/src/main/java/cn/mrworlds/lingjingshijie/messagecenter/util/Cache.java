...
public class Cache {
	...
	public Cache() {
		System.out.println ("redis 缓存启动");
	}
	// ============================Bit==================================

	public boolean setBit(String key, int index, boolean value) {
		try {
	...
	public boolean getBit(String key, int index) {
		return key == null ? null : redisTemplate.opsForValue().getBit(key, index);
	}

	public List<Object> mutiGet(String prefix) {
	...
	public Double hIncr(String key, String field, float value) {
	...
	public void watch(String key, long time) {
	...
	public boolean hExits(String key) {
		return redisTemplate.hasKey(key);
	}
