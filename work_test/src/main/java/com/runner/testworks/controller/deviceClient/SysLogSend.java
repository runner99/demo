...
//                        "#会话开始时间:"+LocalDate.now()+" "+ LocalTime.now().toString().substring(0, 8)+"   #客户端IP:10.11.24.21   #客户端端口:58359   #客户端MAC:30B0377A7D89   #数据库用户:ROOT   #客户端工具:MySQL Connector/J   #客户端主机名称:nwonknu   #操作系统用户:nwonknu   #数据库IP:10.98.100.12   #数据库端口:13306   #数据库MAC:000C29108DB5  #数据库名称:A   #服务(实例)名:mysql   #被保护数据库类型:MySQL";
                String msg = "DBSEC #客户端MAC:7CD30A5E1A40   #数据库用户:DBSCALE_INTERNAL   #客户端工具:无信息   #客户端主机名称:无信息   #操作系统用户:无信息   #数据库IP:10.2.168.159   #数据库端口:19103   #数据库MAC:7CD30A5E1808   #数据库名称:N/A   #服务(实例)名:mysql   #被保护数据库类型:MySQL   #被保护数据库:外网-电力交易统一门户网站系统   #流水标识:2311071446425521954   #捕获时间:2023-11-07 14:46:42   #SQL:SHOW MASTER STATUS;   #操作类型:SHOW MASTER STATUS   #语句长度:19   #受影响对象:N/A   #SQL标识:4449232768550421739   #应答错误号:0   #应答错误信息:   #影响行数:1   #响应时间:105   #结果集:N/A   #执行结果:成功   #风险类型:N/A   #风险级别:N/A   #控制动作:放行   #规则名称:N/A   #应用客户端IP:N/A   #应用客户端端口:0   #应用用户名:N/A   #应用会话标识:N/A     #会话标识:4355086270021000000   #会话开始时间:2023-10-20 15:30:07   #客户端IP:10.2.168.160   #客户端端口:39212";
//                访问事件
